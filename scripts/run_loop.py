...
from abtract.swarm.cli import loop_main  # noqa: E402
...
def main(
    ...
    """`modal run scripts/run_loop.py --site demo --version v0 --iterations 2 ...`"""
    loop_main(site=site, version=version, iterations=iterations, models=models, agents=agents, tasks=tasks,
              local=local, site_base_url=site_base_url or None, concurrency=concurrency,
...
def _cli() -> None:
    ...
    a = p.parse_args()
    local = not a.modal
    kwargs = dict(site=a.site, version=a.version, iterations=a.iterations, models=a.models, agents=a.agents,
                  tasks=a.tasks, local=local, site_base_url=a.site_base_url or None, concurrency=a.concurrency,
